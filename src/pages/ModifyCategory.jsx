    ...
    return (
        <div className="bg-gray-100 flex p-2 md:p-4">
            <div className="px-8 pt-6 pb-8 mb-4 max-w-md w-full">
                <h1 className="text-center text-2xl font-bold mb-6">Add category</h1>
                <form>
                    <div className="mb-4">
                        <label className="block text-gray-700 font-bold mb-2" htmlFor="categoryName">
                            Category name
                        </label>
                        <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="categoryName" placeholder="Enter category name" />
                    </div>
                    <div className="mb-4 flex justify-between">
                        <div className='block text-gray-700 font-bold'>Category status</div>
                        <div>
